...
import com.idaltchion.ifxfood.api.v1.assembler.CidadeDTOAssember;
import com.idaltchion.ifxfood.api.v1.assembler.CidadeDTODisassembler;
import com.idaltchion.ifxfood.api.v1.model.CidadeDTO;
import com.idaltchion.ifxfood.api.v1.model.input.CidadeDTOInput;
import com.idaltchion.ifxfood.api.v1.openapi.controller.CidadeControllerOpenAPI;
...
@RestController
@RequestMapping(path = "/cidades", produces = IfxMediaTypes.V1_APPLICATION_JSON_VALUE)
